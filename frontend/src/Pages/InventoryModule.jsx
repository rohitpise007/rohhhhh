      ...
      <div className="opd-container">
        ...
        <div className="modules-section">
          ...
          <div className="modules-description">
            <p><strong>Inventory Management Features:</strong></p>
            <ul>
              <li>Track procurement and supply of hospital consumables, equipment, and inventory items</li>
              <li>Automated inventory tracking with low stock alerts and reorder management</li>
              <li>Equipment maintenance scheduling and depreciation tracking</li>
              <li>Barcode/RFID integration for efficient inventory control</li>
              <li>Supplier management and purchase order processing</li>
