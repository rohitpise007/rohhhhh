      ...
      <div className="opd-container">
        ...
        <div className="modules-section">
          ...
          <div className="modules-description">
            <p><strong>Pathology Laboratory Features:</strong></p>
            <ul>
              <li>OP/IP Patient Test Bookings with sample collection tracking</li>
              <li>Sample Collection management and chain of custody</li>
              <li>Test report preparation and automated result validation</li>
              <li>Lab inventory management for reagents and supplies</li>
              <li>Direct integration with Consultant module for result sharing</li>
              <li>Robust interfacing with Lab Machines for auto test result capture</li>
            </ul>
...
export default PathologyModule;
