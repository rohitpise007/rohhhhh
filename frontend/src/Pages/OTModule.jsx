      ...
      <div className="opd-container">
        ...
        <div className="modules-section">
          ...
          <div className="modules-description">
            <p><strong>OT Management Features:</strong></p>
            <ul>
              <li>Book OT and Schedule Surgeries with real-time availability</li>
              <li>Record surgical notes and pre/post-operative care instructions</li>
              <li>Pre and post Anaesthesia follow-ups and monitoring</li>
              <li>OT Consents management and documentation</li>
              <li>Surgical team assignment and resource allocation</li>
              <li>Equipment tracking and sterilization schedules</li>
            </ul>
