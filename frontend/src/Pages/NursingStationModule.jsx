      ...
      <div className="opd-container">
        ...
        <div className="modules-section">
          ...
          <div className="modules-description">
            <p><strong>Nursing Station Management Features:</strong></p>
            <ul>
              <li>Operation of nursing stations with centralized patient information access</li>
              <li>Communication platform across departments for better patient care coordination</li>
              <li>Real-time patient monitoring and vital signs tracking</li>
              <li>Medication administration records and medication safety protocols</li>
              <li>Shift handover documentation and care planning</li>
              <li>Integration with other hospital departments for seamless workflow</li>
            </ul>
...
export default NursingStationModule;
